...
namespace OohelpWebApps.Presentations.Mapping
{
    public static class DtoToViewMapper
    {
        ...
        public static Models.PresentationViewModel ToPresentationViewModel(this PresentationDto dto)
        {
        ...
        public static Models.BoardViewModel ToBoardViewModel(this BoardDto dto)
        {
        ...
        private static object GenerateIcon(BoardDto dto)
        {
            return dto.IconStyle switch
            {
                ...
                /// google.maps.SymbolPath.CIRCLE = 0, google.maps.SymbolPath.FORWARD_CLOSED_ARROW = 2, 
                IconStyle.OldCircle => new { path = 0, fillColor = HexToRgb(dto.IconColor), fillOpacity = 1, strokeWeight = 1, strokeOpacity = 0.7, scale = 6 },                
        ...
        private static string GenerateHtmlInfo(BoardDto dto)
        {
